var WIDGET_URL = "https://smartbotwidget.strellio.co" || "https://smartbot-widget.serveo.net" || 'https://widgetv2.onrender.com' || 'https://smartbotwidget.com';
function getParams(scriptName) {
    var _a, _b, _c, _d;
    var script = document.getElementsByTagName("script");
    for (var i = 0; i < script.length; i++) {
        if (script[i].src.indexOf("/" + scriptName) > -1) {
            var params = (_d = (_c = (_b = (_a = script[i]) === null || _a === void 0 ? void 0 : _a.src) === null || _b === void 0 ? void 0 : _b.split("?")) === null || _c === void 0 ? void 0 : _c.pop()) === null || _d === void 0 ? void 0 : _d.split("&");
            var fullParams = {};
