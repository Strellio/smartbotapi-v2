...
export async function createVectoreStore({ dbName, indexName, collectionName, documents, embeddings = new OpenAIEmbeddings(), textKey="text", embeddingKey="embedding" }) {
