...
const PLANS = [
  ...
  // },
  {
    ...
    icon_class: 'bx bx-car',
    duration: PlanDuration.MONTHLY,
    display_features:["Full access to smartbot", "Live chat support", "Connect with SmartChat, Intercom or HubSpot", "Maximum of 2 live agents" , "Customize chat to suit your brand"],
  ...
  },
  {
    ...
    free_trial_days: 30,
    icon_class: 'bx bx-car',
    display_features:["All Starter features, plus:", "Connect with Facebook messenger", "Maximum of 10 live agents" ],
    features: {
      allowed_external_platforms: [
        CHAT_PLATFORMS.CUSTOM,
        CHAT_PLATFORMS.INTERCOM,
  ...
  },
  {
    ...
    price: 99.99,
    display_features: ["All Pro features, plus:", "Unlimited number of live agents", "Remove SmartBot label from chat widget", "Premium customer support"],
    duration: PlanDuration.MONTHLY,
    free_trial_days: 30,
    icon_class: 'bx bx-car',
    features: {
